...
export const ClipEditing = ({finalClips, onBack, url}) => {
    ...
    async function downloadClips(url, clips, splitscreenUrl, splitscreenClips){
      try {
          const res = await (await fetch('http://127.0.0.1:5000/download_clips',
          {
          method: 'POST',
          cache: "no-cache",
          headers: {
            ...
            {!confirmSplitscreen ? (
                ...
                {!proceed ? (
                    ...
                    {!downloadComplete ? (
                      ...
                      {!finalEdits ? (
                        <>
                        <h1 class='downloading'>Downloading clips</h1>
                        </>
                      ) : (
                        <>
  ...
  function formatTime(time){
    ...
    return (
        <div className="splitscreenClips">
            ...
            <div class="edits row" id='split-edits'>
              <EditTimesForm 
...
const EditTimesForm = props => {
    ...
    return (
      <>
        <form id="clip-times" class='col-md-10'>
            <label>
                Clip Start:&nbsp;
